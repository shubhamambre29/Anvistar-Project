...
<head>
    ...
    <title>Employee Dashboard - DXSure CRM</title>
...
<body>
    ...
    <div class="page-header">
        ...
        <p class="subtitle">Manage clients, vendors, and support tickets</p>
    </div>
    ...
    <div class="container">
        <div class="dashboard-container">
            ...
            <div class="dashboard-card">
                ...
                <div class="label">Client Enquiries</div>
            </div>
            
            <div class="dashboard-card">
                <h3>Active Leads</h3>
                <div class="number">12</div>
                <div class="label">New Business Leads</div>
            </div>
            
            <div class="dashboard-card">
                <h3>Vendor Payments</h3>
                <div class="number">₹1.2L</div>
        ...
        <div style="background: white; padding: 2rem; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); margin-bottom: 2rem;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 1rem;">
                <a href="client_list.jsp" class="btn btn-primary" style="text-align: center;">View Clients</a>
                <a href="vendor_list.jsp" class="btn btn-success" style="text-align: center;">Manage Vendors</a>
                <a href="ticket_list.jsp" class="btn btn-info" style="text-align: center;">Create Ticket</a>
                <a href="payment_list.jsp" class="btn btn-primary" style="text-align: center;">Payments</a>
                <a href="pettycash_list.jsp" class="btn btn-success" style="text-align: center;">Petty Cash</a>
                <a href="enquiry.jsp" class="btn btn-danger" style="text-align: center;">New Enquiry</a>
            </div>
        </div>
    </div>
